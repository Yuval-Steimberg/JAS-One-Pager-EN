    ...
    >
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-forest/60" dir="ltr">{CONTACT.whatsappDisplay}</p>
            </div>
          </motion.a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-forest/60" dir="ltr">{CONTACT.email}</p>
            </div>
          </motion.a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-forest/60" dir="ltr">{CONTACT.instagramHandle}</p>
            </div>
          </motion.a>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-col justify-center rounded-xl2 bg-forest p-8 text-cream shadow-lift sm:p-10"
        >
          <h3 className="text-2xl font-bold">{CONTACT_SECTION.newsletter.title}</h3>
          <p className="mt-2 text-cream/70">{CONTACT_SECTION.newsletter.text}</p>

          {sent ? (
            <p className="mt-6 rounded-xl bg-ember/15 px-4 py-3 text-ember-400">
              תודה! נשמור על קשר ✦
            </p>
          ) : (
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <input
                ...
                className="w-full flex-1 rounded-full bg-cream/10 px-5 py-3 text-cream placeholder:text-cream/40 focus:bg-cream/15 focus:outline-none focus-visible:outline-2 focus-visible:outline-ember"
              />
