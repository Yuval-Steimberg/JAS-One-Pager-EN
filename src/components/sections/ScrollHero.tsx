  ...
  return (
    ...
    >
      <div className="on-dark sticky top-0 flex h-[100svh] w-full items-center justify-center overflow-hidden">
        ...
        <div
          aria-hidden
          className="absolute inset-0 bg-gradient-to-b from-forest-900/70 via-forest-900/45 to-forest-900/90"
        />
        ...
        {/* Scroll cue */}
        <div className="absolute bottom-8 left-1/2 flex -translate-x-1/2 flex-col items-center gap-2 text-cream/70">
