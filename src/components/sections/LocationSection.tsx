        ...
        >
          <motion.div variants={fadeUp} className="flex gap-4 rounded-xl2 bg-white p-6 shadow-soft">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1.5">
                {CONTACT.hours.map((h) => (
                  <li key={h.day} className="flex justify-between text-sm text-forest/70">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-forest/70">{CONTACT.address}</p>
            </div>
          </motion.a>

          <motion.div variants={fadeUp} className="flex items-center gap-4 rounded-xl2 bg-white p-6 shadow-soft">
            <Car className="h-6 w-6 shrink-0 text-ember" />
            <div>
              <h3 className="text-lg font-bold">הגעה וחניה</h3>
              <p className="text-sm text-forest/70">חניה חופשית בסביבה · נגיש בתחבורה ציבורית</p>
            </div>
          </motion.div>
