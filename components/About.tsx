...
export function About() {
  return (
    <section
      ...
      className="texture-paper relative overflow-hidden scroll-mt-[72px] py-20 sm:py-28 lg:py-32"
    >
      <KineticWord
        text="UPCYCLING · מיחדוש"
        direction="ltr"
        className="top-10 text-[18vw] text-clay/[0.05]"
      />
      <div className="container relative">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative">
            ...
            >
              <div className="overflow-hidden rounded-xl2 border-4 border-ivory shadow-lift">
                <img
          ...
          >
            ...
            {ABOUT.paragraphs.map((p, i) => (
              <motion.p
                key={i}
                variants={fadeUp}
                className="mb-4 text-base leading-relaxed text-ink/70 sm:text-lg"
              >
                {p}
              </motion.p>
            ))}
            <motion.p
              variants={fadeUp}
              className="mt-8 border-s-2 border-clay ps-5 font-display text-xl font-bold leading-snug text-ink sm:text-2xl"
            >
              {ABOUT.signature}
            </motion.p>
          </motion.div>
