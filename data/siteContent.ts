...
/** Resolve a /public/images asset (served at the site root by Next.js). */
export const asset = (file: string) => `/images/${file}`;

/** Resolve a /public/videos asset (served at the site root by Next.js). */
export const videoAsset = (file: string) => `/videos/${file}`;
...
export const HERO = {
  ...
  subtitle:
    "Just A Second מחברת בין קיימות, עיצוב וקהילה — דרך מיחדוש, שימוש חוזר וחפצים עם סיפור.",
